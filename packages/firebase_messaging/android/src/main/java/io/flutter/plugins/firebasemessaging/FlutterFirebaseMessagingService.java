...
public class FlutterFirebaseMessagingService extends FirebaseMessagingService {
  ...
  public void onMessageReceived(final RemoteMessage remoteMessage) {
    ...
    while (it.hasNext()) {
      ...
      Log.e("MyTag","----onMessageReceived " + pair.getKey() + " = " + pair.getValue());
    }
    Log.e("MyTag","onMessageReceived isInComingCallNotification = " + isInComingCallNotification(remoteMessage));
